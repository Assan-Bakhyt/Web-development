...
export class ProductListComponent {
  ...
  },
  {
    ...
    description: 'Самая легкая и быстрая игровая мышь в линейке Logitech. Разработана совместно с профессиональными киберерспортсменами. Датчик HERO 25K обеспечивает идеальную точность.',
    price: 58000,
    rating: 5.0,
  ...
  },
  {
    ...
    description: 'Планетарный миксер...',
    price: 320000,
    rating: 4.8,
